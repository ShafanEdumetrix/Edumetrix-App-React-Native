...
import NotificationFollowerScreen from './NotificationFollowerScreen';
...
class NotificationFollowerScreenContainer extends Component {
    constructor(props) {
        super(props);
    }

    render() {
        return <NotificationFollowerScreen {...this.props} />;
    }
}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(NotificationFollowerScreenContainer);
