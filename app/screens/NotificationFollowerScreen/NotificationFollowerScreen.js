...
class NotificationFollowerScreen extends Component {
    constructor(props){
        super(props);
        this.state={
        };
...
renderItem=({item,index})=>{         
    ...
    item.type === 'Followed' && 
            ...
            <View>
               ...
               onPress={()=>{
                   this.props.requestReadNotification(this.props.token,item.notification_id)
               }}>
...
NotificationFollowerScreen.propTypes = {
    navigation: PropTypes.func,
    navigateToSignUp: PropTypes.func
};

export default NotificationFollowerScreen;
